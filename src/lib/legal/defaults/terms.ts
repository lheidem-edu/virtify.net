...
const document: LegalDocumentData = {
    ...
    intro: "Diese Bedingungen gelten für die Bereitstellung und den Betrieb von KVM-Instanzen durch {{operatorName}} ({{siteName}}). Sie ergänzen den jeweils geschlossenen Einzelvertrag; abweichende Regelungen darin gehen vor.\n\nDie bloße Nutzung dieser Website begründet weder ein Vertragsverhältnis noch eine Zahlungspflicht.",
    sections: [
        {
            title: "Geltungsbereich und Begriffe",
            variant: "paren",
            items: [
                "Diese Allgemeinen Geschäftsbedingungen gelten für alle Verträge über die Bereitstellung und den Betrieb informationstechnischer Infrastruktur in Form von KVM-Instanzen (virtuellen Maschinen) sowie damit verbundene Leistungen zwischen {{operatorName}} , {{operatorStreet}}, {{operatorCity}}, {{operatorCountry}}, handelnd unter {{siteName}} (nachfolgend „Anbieter“), und dem Kunden.",
                "Der Anbieter ist unter [{{operatorEmail}}](mailto:{{operatorEmail}}) erreichbar. Diese Adresse ist zugleich Kontaktstelle nach Art. 11 und 12 der Verordnung (EU) 2022/2065 sowie nach Art. 15 der Verordnung (EU) 2021/784. Die Kommunikation erfolgt in deutscher oder englischer Sprache.",
        ...
        },
        {
            ...
            variant: "paren",
            items: [
                "Für die Verwaltung der Leistungen stellt der Anbieter unter [{{siteName}}/account](/account) einen Kundenbereich bereit. Dort kann der Kunde seine Stammdaten pflegen sowie Verträge, Angebote und Rechnungen einsehen. Die Einrichtung eines Kontos ist unentgeltlich und begründet für sich genommen keine Zahlungspflicht.",
        ...
        },
        {
            ...
            items: [
                ...
                "Die Rechnungsstellung erfolgt, soweit nicht anders vereinbart, im Voraus für den jeweiligen Abrechnungszeitraum. Die Zahlung ist innerhalb von {{paymentTermDays}} Tagen nach Rechnungsdatum ohne Abzug fällig.",
                ...
                "Der Kunde kann im [Kundenbereich](/account) für einen Vertrag ein Zahlungsmittel hinterlegen. Damit ermächtigt er den Anbieter, die für diesen Vertrag ausgestellten Rechnungen mit ihrer Ausstellung über das hinterlegte Zahlungsmittel einzuziehen, frühestens jedoch am Rechnungsdatum. Rechnungen aus anderen Verträgen werden darüber nicht eingezogen. Der Kunde kann die Ermächtigung jederzeit im Kundenbereich mit Wirkung für die Zukunft widerrufen; bereits eingezogene Beträge bleiben davon unberührt.",
        ...
        },
        {
            ...
            items: [
                ...
                "Kündigungen bedürfen der Textform, etwa per E-Mail oder Ticket. Verbraucher, die den Vertrag über die Website geschlossen haben, können die Kündigung zusätzlich über die [Kündigungsschaltfläche](/cancellation) nach § 312k BGB erklären; diese ist auf jeder Seite von {{siteName}} unmittelbar erreichbar. Den Eingang der Kündigung bestätigt der Anbieter unverzüglich in Textform an die dabei angegebene E-Mail-Adresse.",
                "Der Kunde ist verpflichtet, seine Daten vor Vertragsende zu sichern. Der Anbieter hält die Daten des Kunden nach Vertragsende noch mindestens {{dataRetrievalDays}} Tage zum Abruf bereit und löscht die Instanz einschließlich der darauf gespeicherten Daten erst nach Ablauf dieser Frist. Innerhalb dieser Frist unterstützt der Anbieter den Kunden im Rahmen seiner betrieblichen Möglichkeiten beim Datenexport. Eine frühere Löschung erfolgt nur auf Verlangen des Kunden oder soweit rechtliche Gründe sie gebieten.",
            ],
            label: "§ 8",
        },
        {
            ...
            items: [
                ...
                "Dringende sicherheitsrelevante Wartungen — insbesondere das Einspielen von Aktualisierungen zur Schließung bekannt gewordener Schwachstellen — kann der Anbieter mit verkürzter Frist ankündigen. Die Ankündigung erfolgt so früh wie möglich, in der Regel jedoch mindestens {{securityMaintenanceNoticeHours}} Stunden im Voraus in Textform. Auch diese Wartungen gelten nicht als Ausfallzeit.",
                ...
                "Nicht als Ausfallzeit gelten ferner Zeiten, in denen die Instanz aus Gründen außerhalb des Einflussbereichs des Anbieters nicht erreichbar ist, insbesondere höhere Gewalt, Störungen bei Providern außerhalb des vom Anbieter betriebenen Netzes, Ausfälle der Basisinfrastruktur des Rechenzentrums, Distributed-Denial-of-Service-Angriffe sowie vom Kunden verursachte Fehlfunktionen oder Konfigurationsfehler.",
        ...
        },
        {
            ...
            items: [
                ...
                {
                    text: "Untersagt sind insbesondere:",
                    items: [
        ...
        },
        {
            ...
            items: [
                ...
                "Meldungen über mutmaßlich terroristische Inhalte sind elektronisch an die Kontaktstelle des Anbieters zu richten: [{{operatorEmail}}](mailto:{{operatorEmail}}) .",
        ...
        },
        {
            ...
            items: [
                ...
                {
                    text: "Rechtswidrig sind insbesondere Inhalte, die",
                    items: [
                ...
                "Der Kunde und Dritte können mutmaßlich rechtswidrige Inhalte jederzeit elektronisch an die Kontaktstelle des Anbieters nach Art. 11 und 12 der Verordnung (EU) 2022/2065 melden: [{{operatorEmail}}](mailto:{{operatorEmail}}) . Die Meldung soll die beanstandeten Inhalte hinreichend genau bezeichnen und begründen.",
        ...
        },
        {
            ...
            variant: "prose",
            items: [
                "Der Kunde stellt den Anbieter von Ansprüchen Dritter frei, die auf einer rechtswidrigen Nutzung der Leistungen durch den Kunden oder auf den von ihm gespeicherten Inhalten beruhen, einschließlich der angemessenen Kosten der Rechtsverteidigung. Der Kunde unterstützt den Anbieter bei der Abwehr solcher Ansprüche. Dies gilt nicht, soweit der Kunde die Rechtsverletzung nicht zu vertreten hat.",
            ],
            label: "§ 15",
        },
        {
            ...
            items: [
                ...
                "Für die Verarbeitung beim Besuch dieser Website gilt die [Datenschutzerklärung](/privacy) .",
            ],
            label: "§ 16",
        },
        {
            ...
            variant: "prose",
            items: [
                "Ereignisse höherer Gewalt, die der Anbieter nicht zu vertreten hat — insbesondere Naturkatastrophen, Krieg, Terrorakte, Streiks, behördliche Anordnungen sowie großflächige Strom- oder Netzausfälle — befreien die Vertragsparteien für ihre Dauer von den betroffenen Leistungspflichten. Dauert ein solcher Zustand länger als sechs Wochen an, kann jede Vertragspartei den Vertrag außerordentlich kündigen.",
            ],
            label: "§ 17",
        },
        {
        ...
        },
        {
            ...
            items: [
                ...
                "Um Ihr Widerrufsrecht auszuüben, müssen Sie uns ( {{operatorName}}, {{operatorStreet}}, {{operatorCity}}, {{operatorCountry}}, E-Mail: [{{operatorEmail}}](mailto:{{operatorEmail}}) ) mittels einer eindeutigen Erklärung, etwa per E-Mail oder Ticket, über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren. Sie können dafür das [Muster-Widerrufsformular (PDF)](/withdrawal-form) verwenden, das jedoch nicht vorgeschrieben ist.",
                ...
                "Die Anrede in dieser Belehrung folgt dem gesetzlichen Mustertext nach Anlage 1 zu Art. 246a EGBGB.",
            ],
            label: "§ 20",
        },
        {
            ...
            variant: "prose",
            items: [
                "Das Muster-Widerrufsformular nach Anlage 2 zu Art. 246a § 1 Abs. 2 Satz 1 Nr. 1 EGBGB steht als PDF zum Abruf bereit. Seine Verwendung ist nicht vorgeschrieben; der Widerruf kann auch formlos in Textform erklärt werden.",
            ],
            label: "§ 21",
            action: {
                href: "/withdrawal-form",
                label: "Muster-Widerrufsformular (PDF)",
            },
        },
        {
